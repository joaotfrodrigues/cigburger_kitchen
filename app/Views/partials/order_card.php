<div class="col-xl-6 col-12">
    <div class="order-wrapper">
        ...
        <div class="d-flex flex-wrap flex-md-nowrap order-content justify-content-between" style="background-color: <?= order_color($order['order_number']) ?>">
            <!-- order number -->
            ...
            <!-- order total items -->
            <div class="order-content-item ms-2 order-content-total-items d-flex align-items-center justify-content-center text-warning">
            ...
            <div class="d-flex order-content justify-content-between">
                <!-- delete order -->
                ...
                <!-- handle the order -->
                <a href="<?= site_url('/handle_order/' . Encrypt($order['id'])) ?>" class="ms-2 btn btn-success p-3 px-4 d-flex align-items-center justify-content-center">
